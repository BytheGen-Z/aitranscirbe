...
export async function POST(req: Request) {
    try {
        ...
        // 2. Send to OpenAI Whisper for Translation (Forces English)
        console.log('Sending to Whisper API (Translation mode)...');
        ...
        console.log('Transcription mapped successfully. Length:', transcriptText.length);
        ...
        console.log('Sending to Groq LLaMA for Summarization...');
